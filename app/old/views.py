...
@old.route('/menu', methods=['GET', 'POST'])
def menu():
    form = ButtonForm()
    global cookingIdx
    global mealtype
...
@old.route('/cooking',methods = ['GET', 'POST'])
def cooking():
    global cookingIdx
    server_ip = get_lan_ip()
    if request.method == 'GET':
...
@old.route('/login',methods = ['GET', 'POST'])
def login():
    global user
    server_ip = get_lan_ip()
    if request.method == 'GET':
        ...
        return render_template('old/account.html',
            user = user,
            server_ip = server_ip)

@old.route('/account',methods = ['GET', 'POST'])
def account():
    server_ip = get_lan_ip()
    if request.method == 'GET':
        user = { 'nickname': 'Diaosi'}
...
@old.route('/favorite',methods = ['GET', 'POST'])
def favorite():
    server_ip = get_lan_ip()
    if request.method == 'GET':
        user = { 'nickname': 'Diaosi'}
...
@old.route('/shopping',methods = ['GET', 'POST'])
def shopping():
    server_ip = get_lan_ip()
    if request.method == 'GET':
        user = { 'nickname': 'Diaosi'}
...
@old.route('/uploading',methods = ['GET', 'POST'])
def uploading():
    server_ip = get_lan_ip()
    if request.method == 'GET':
        user = { 'nickname': 'Diaosi'}
...
@old.route('/coding',methods = ['GET', 'POST'])
def coding():
    server_ip = get_lan_ip()
    if request.method == 'GET':
        user = { 'nickname': 'Diaosi'}
        return render_template('blockly/apps/maze/WriteYourRecipe.html',
            user = user,
            server_ip = server_ip)
